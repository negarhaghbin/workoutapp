...
class AppExercise: Object {
    ...
    class func initAppExerciseTable(){
        ...
        AppExercise(e: realm!.object(ofType: Exercise.self, forPrimaryKey: Exercise.getCompoundKey(name: "Flutter Kicks", type: lower))!, g:"flutter-kicks",  v:"eEG9uXjx4vQ", d: Duration(durationInSeconds: 25), eq:"").add()
            
        AppExercise(e: realm!.object(ofType: Exercise.self, forPrimaryKey: Exercise.getCompoundKey(name: "Clench/Unclench Overhead", type: upper))!, g:"clench-unclench-overhead",  v:"", d: Duration(durationInSeconds: 30), eq:"").add()
        AppExercise(e: realm!.object(ofType: Exercise.self, forPrimaryKey: Exercise.getCompoundKey(name: "Clench/Unclench Arms Raised to the Side", type: upper))!,  g:"clench-unclench-side",  v:"", d: Duration(durationInSeconds: 60), eq:"").add()
        AppExercise(e: realm!.object(ofType: Exercise.self, forPrimaryKey: Exercise.getCompoundKey(name: "Raised Arm Circles", type: upper))!, g:"raised-arm-circles",  v:"", d: Duration(durationInSeconds: 30), eq:"").add()
        AppExercise(e: realm!.object(ofType: Exercise.self, forPrimaryKey: Exercise.getCompoundKey(name: "Arms Raised to the Side Hold", type: upper))!, g:"hold", v:"", d: Duration(durationInSeconds: 60), eq:"").add()
        AppExercise(e: realm!.object(ofType: Exercise.self, forPrimaryKey: Exercise.getCompoundKey(name: "Bicep Extensions", type: upper))!, g:"bicep-extensions", v:"", d: Duration(durationInSeconds: 30), eq:"").add()
        AppExercise(e: realm!.object(ofType: Exercise.self, forPrimaryKey: Exercise.getCompoundKey(name: "Bicep Extensions Hold", type: upper))!, g:"bicep-extension-hold", v:"", d: Duration(durationInSeconds: 60), eq:"").add()
    }
