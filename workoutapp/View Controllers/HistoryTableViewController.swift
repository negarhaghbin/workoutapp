...
class HistoryTableViewController: UITableViewController {
    let allRoutines = dailyRoutine.getAll()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.dateLabel.text = allRoutines[indexPath.row].dateString
        cell.durationLabel.text = timeString(seconds: allRoutines[indexPath.row].seconds)
